...
const Category = ({categoryName,imgUrl,numberOfItems,bgColor,isSelected,onClick}) => {
    return (
        <div onClick={onClick} style={{backgroundColor:bgColor, cursor:'pointer'}} className='d-flex align-items-center p-3 rounded gap-1 position-relative category-hover '>
